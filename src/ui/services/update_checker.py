...
from src.ui import UIUtils, invoke_later, is_qobject_alive, run_on_ui_thread
        ...
        def _work() -> None:
            ...
            try:
                ...
                if not asset:
                    ...
                    if html_url:
                        UIUtils.open_external_url(html_url)
                    return
                ...
                download_result = HTTPClient.download_file(
                    ...
                    expected_hash_algorithm=alg,
                )
                if download_result.success:
                    logger.info(f"[驗證階段] HTTP 串流已完成 {alg.upper()} 雜湊驗證")
