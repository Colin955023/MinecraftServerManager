...
from src.utils import get_logger, invoke_later
...
class PageRouter:
    ...
    def show_page_frame(self, frame) -> None:
        ...
        if frame:
            ...
            if (
                hasattr(self.main_window, "navigationInterface")
                and self.main_window.navigationInterface
                and frame.objectName()
            ):
                self.main_window.navigationInterface.setCurrentItem(frame.objectName())
