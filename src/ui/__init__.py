...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ModProvider": (".mod_search_service.provider_protocol", "ModProvider"),
    ...
    "ProviderDependencyContext": (".mod_search_service.provider_protocol", "ProviderDependencyContext"),
    "ProviderDownloadContract": (".mod_search_service.provider_protocol", "ProviderDownloadContract"),
    ...
    "enhance_local_mod": (".mod_search_service.provider_adapter", "enhance_local_mod"),
    "get_mod_versions": (".mod_search_service.provider_adapter", "get_mod_versions"),
    "get_recommended_mod_version": (".mod_search_service.provider_adapter", "get_recommended_mod_version"),
    "normalize_mod_search_query": ("..utils", "normalize_mod_search_query"),
    "resolve_modrinth_project_names": (
        ".mod_search_service.provider_adapter",
        "resolve_modrinth_project_names",
    ),
    "search_mods_online": (".mod_search_service.provider_adapter", "search_mods_online"),
    ...
    "get_mod_version_details": (".mod_search_service.provider_adapter", "get_mod_version_details"),
    "get_mod_provider": (".mod_search_service.provider_adapter", "get_mod_provider"),
    ...
    "get_modrinth_project_info": (".mod_search_service.provider_adapter", "get_modrinth_project_info"),
    ...
    "resolve_local_mod_project_info": (".mod_search_service.provider_adapter", "resolve_local_mod_project_info"),
