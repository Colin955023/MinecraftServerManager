...
class ManageServerService:
    ...
    def build_server_refresh_execution_plan(
        self, payload: ServerRefreshPayload, current_token: int, selected_server: str | None
        ...
        refresh_context = ServerRefreshContext(refresh_token=current_token, previous_selection=selected_server)
