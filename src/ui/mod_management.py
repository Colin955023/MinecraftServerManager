...
class ModManagementFrame:
    ...
    def create_browse_mods_tab(self):
        ...
        notice = ctk.CTkLabel(
            ...
            font=get_font(size=int(24 * font_manager.get_scale_factor()), weight="bold"),
            text_color=("#64748b", "#64748b"),
        )
    ...
    def create_notebook(self):
        ...
        # 設置頁籤字體使用DPI縮放
        style = ttk.Style()
        style.configure("Tab", font=("Microsoft JhengHei", int(18 * font_manager.get_scale_factor()), "bold"))
    ...
    def show_local_context_menu(self, event):
        ...
        menu = tk.Menu(self.parent, tearoff=0, font=("Microsoft JhengHei", int(9 * scale_factor)))  # 動態字體縮放
