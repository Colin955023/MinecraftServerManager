...
from ...utils.server_utils.server_constants import (
...
from ..system.java_manager import JavaManager
...
class ServerOperations:
    ...
    @staticmethod
    def graceful_stop_server(server_startup, server_name: str) -> bool:
        """
        ...
        """
        try:
            command_success = server_startup.send_command(server_name, "stop")
            return command_success or server_startup.stop_server(server_name)
...
class ServerCommands:
    ...
    def resolve_java_executable(server_config, fallback: str = "java") -> str:
        ...
        try:
            java_path = JavaManager.get_best_java_path(
                mc_version,
    ...
    def build_java_command(server_config, return_list: bool = False) -> list[str] | str:
        ...
        java_exe = ServerCommands.resolve_java_executable(server_config)
        from .server_detection import ServerDetectionUtils as _SD

        main_jar = _SD.find_main_jar(server_path, loader_type, server_config)
