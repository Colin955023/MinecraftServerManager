...
class SettingsManager:
    ...
    # 設定伺服器根目錄
    def set_servers_root(self, path: str):
        """
        設定伺服器根目錄路徑
    ...
    # 設定是否記住視窗大小位置
    def set_remember_size_position(self, enabled: bool):
        """
        設定是否記住視窗大小和位置的功能開關
    ...
    # 設定主視窗大小位置
    def set_main_window_settings(self, width: int, height: int, x: int = None, y: int = None, maximized: bool = False):
        """
        設定主視窗的大小、位置和最大化狀態
    ...
    # 設定自適應大小調整
    def set_adaptive_sizing(self, enabled: bool):
        """
    ...
    # 設定 DPI 縮放因子
    def set_dpi_scaling(self, scaling: float):
        """
